...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "4jqkm38tQfD8BfCz2u851GvXEeuiDPntA1jksNBCi6DS";
        String sdkKey = "3or2KeR9ywxMj52uiZ9CbY8eeHTRsWDQqaGKDkLE27uK";

        String path = System.getProperty("user.dir");
        System.out.println("读取项目路径："+path);
        FaceEngine faceEngine = new FaceEngine(path+"\\win64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("F:\\图片\\收藏专用\\chao.jpg"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("F:\\图片\\收藏专用\\ku.jpg"));
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("F:\\图片\\收藏专用\\chao.jpg"));
